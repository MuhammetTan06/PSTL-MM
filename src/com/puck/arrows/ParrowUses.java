...
public class ParrowUses extends Parrow{
    ...
    public ParrowUses(Point2D from, Point2D to, double spacing,Point2D virtuaFrom,Point2D virtualTo, String edgeViolation, int arrowType){
    ...
    public ParrowUses(PNode from, PNode to, double spacing, PNode virtualForm, PNode virtualTo, String edgeViolation, int arrowType){
